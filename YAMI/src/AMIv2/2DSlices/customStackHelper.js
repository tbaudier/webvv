...
/**
 * Taken from AMI.stackHelper
 * changes :
 *   - calls our custom SliceHlper

/** * Imports ***/
import {helpersSlice} from './customSliceHelper';
...
const helpersStack = (three = window.THREE) => {
  ...
  return class extends Constructor {
     ...
     */
    _prepareBBox() {
      this._bBox = new AMI.BoundingBoxHelper(this._stack);
      this.add(this._bBox);
    }
     ...
     */
    _prepareBorder() {
      this._border = new AMI.BorderHelper(this._slice);
