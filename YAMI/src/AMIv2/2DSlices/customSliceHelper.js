...
/**
 * Taken from AMI.SliceHelper
 * changes :
 *   - _create sends another kind of thexture
 *   - AMI.helpers.material.mixin => customMaterialMixin
 */
...
const helpersSlice = (three = window.THREE) => {
  ...
  return class extends Constructor {
    ...
    _create() {
      ...
      // Convenience vars
      try {
        const SliceGeometryContructor = AMI.sliceGeometryFactory(three);
