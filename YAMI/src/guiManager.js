...
function f() {
   ...
   * @param {Object} info information as generated by requestManager
  ...
  /**
   * Creates the GUI of the the Fusion folder
   *
   * @param  {DataUniformShader} fusionUni Uniforms of the fusion data
   */
  ...
  /**
   * Creates the GUI of the the Overlay folder
   *
   * @param  {DataUniformShader} overlayUni Uniforms of the overlay data
   */
  ...
  /**
   * Creates the GUI for each struct
   */
